...
public class TestWordFinder {
    ...
    public static void main(String[] args) {
        ...
        String[] positiveMatches = {"que","reinstate", "stare", "note", "rat", "diner", 
        "ranted", "toned", "runt", "doer", "near", "dent", "at", "ten", "note", "ran", "ten", 
        "net", "bind", "send", "dib", "die", "train", "seat", "era", "quest", "treated"};
        
        String[] negativeMatches = {"need", "tent", "seats", "tennis", "snots", 
        "dented", "dean", "bean", "computer", "a", "rust", "boggle", "dire", "street",
        "nine", "true", "tote", "deer", "rude"};
